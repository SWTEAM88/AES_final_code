...
/* =============================================================================
 * =============================================================================
 * AES 암호화/복호화 테스트 함수 섹션
 * =============================================================================
 * 이 섹션은 AES 블록 암호화 모드(ECB, CBC, CTR)의 테스트 함수들을 포함합니다.
 * 각 함수는 암호화/복호화 작업을 수행하며, HMAC을 사용한 무결성 검증을 포함합니다.
 * =============================================================================
 * ============================================================================= */
 ...
 * SHA 해시 함수 사용 섹션
 * =============================================================================
 * 이 섹션은 SHA-256 해시 함수를 사용하는 함수들을 포함합니다.
 * PSK 생성 및 키 파생에 SHA-256이 사용됩니다.
 * =============================================================================
 * ============================================================================= */
 ...
 * HMAC 무결성 검증 섹션
 * =============================================================================
 * 이 섹션은 HMAC을 사용한 메시지 무결성 검증 함수들을 포함합니다.
 * HMAC-SHA256/512를 사용하여 암호문의 무결성을 검증합니다.
 * =============================================================================
 * ============================================================================= */
 ...
 * 네트워크 통신 섹션
 * =============================================================================
 * 이 섹션은 네트워크를 통한 암호화 데이터 송수신 함수들을 포함합니다.
 * sender_mode: 암호화된 데이터를 패킷으로 구성하여 네트워크로 전송
 * receiver_mode: 네트워크로부터 패킷을 수신하여 복호화 및 무결성 검증
 * =============================================================================
 * ============================================================================= */
 ...
 * 성능 측정 섹션
 * =============================================================================
 * 이 섹션은 성능 측정 관련 함수 호출을 포함합니다.
 * performance_test 함수는 performance.c에 구현되어 있으며,
 * AES 암호화/복호화의 성능을 측정합니다.
 * =============================================================================
 * ============================================================================= */
